...
class Comments
{
        ...
        return [
            ...
            'form' => [
                ...
                [
                    ...
                    'search_config' => [
                        'form_type'             => 'module',
                        'template'              => '../../../plugins/view/intellectstools/admin/comments/module/goods_category',
                ...
                [
                    'label'         => '操作',
                    'view_type'     => 'operate',
                    'view_key'      => '../../../plugins/view/intellectstools/admin/comments/module/operate',
                    'align'         => 'center',
                    'fixed'         => 'right',
                ],
            ],
    ...
    public function WhereValueGoodsCategory($value, $params = [])
    {
        if(!empty($value))
        {
            ...
            // 获取分类下的所有分类 id
            $ids = GoodsService::GoodsCategoryItemsIds($value, 1);
            // 避免空条件造成无效的错觉
