...
class Currency extends Common
{
    ...
    public function Index($params = [])
    {
        ...
        return MyView('../../../plugins/view/exchangerate/admin/currency/index');
    }
    ...
    public function Detail($params = [])
    {
        ...
        return MyView('../../../plugins/view/exchangerate/admin/currency/detail');
    }
    ...
    public function SaveInfo($params = [])
    {
        ...
        MyViewAssign('data', $data);
        MyViewAssign('params', $params);
        return MyView('../../../plugins/view/exchangerate/admin/currency/saveinfo');
    }
