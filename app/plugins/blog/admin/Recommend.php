...
class Recommend extends Common
{
	...
	{
		// 总数
        $total = RecommendService::RecommendTotal($this->form_where);
        ...
        $page_params = [
            ...
            'page'      =>  $this->page,
            'url'       =>  PluginsAdminUrl('blog', 'recommend', 'index'),
        ];
        ...
        return MyView('../../../plugins/view/blog/admin/recommend/index');
	}
    ...
    public function Detail($params = [])
    {
        ...
        return MyView('../../../plugins/view/blog/admin/recommend/detail');
    }
	...
	public function SaveInfo($params = [])
	{
        ...
        // 静态数据
        MyViewAssign('home_floor_location_list', BaseService::$home_floor_location_list);
        ...
        return MyView('../../../plugins/view/blog/admin/recommend/saveinfo');
	}
     ...
     * @param   [array]           $params [输入参数]
     */
    public function BlogSearch($params = [])
    {
        // 是否ajax请求
        if(!IS_AJAX)
        {
        ...
        // 搜索数据
        return BaseService::BlogSearchList($params);
    }
}
?>