    ...
    public function Run($params = [])
    {
        return [
            ...
            'base' => [
                'key_field'     => 'id',
                'is_search'     => 1,
                'search_url'    => PluginsAdminUrl('distribution', 'profit', 'index'),
            ],
            // 表单配置
            'form' => [
                [
                ...
                [
                    'label'         => '结算状态',
                    'view_type'     => 'module',
                    'view_key'      => '../../../plugins/view/distribution/admin/profit/module/status',
                    'is_sort'       => 1,
                    'search_config' => [
                        'form_type'         => 'select',
                        'form_name'         => 'o.status',
                ...
                [
                    'label'         => '操作',
                    'view_type'     => 'operate',
                    'view_key'      => '../../../plugins/view/distribution/admin/profit/module/operate',
                    'align'         => 'center',
                    'fixed'         => 'right',
                ],
            ],
