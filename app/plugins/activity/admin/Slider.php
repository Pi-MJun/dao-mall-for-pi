...
class Slider extends Common
{
    ...
    public function Index($params = [])
    {
        ...
        return MyView('../../../plugins/view/activity/admin/slider/index');
    }
    ...
    public function Detail($params = [])
    {
        ...
        return MyView('../../../plugins/view/activity/admin/slider/detail');
    }
    ...
    public function SaveInfo($params = [])
    {
        ...
        MyViewAssign('data', $data);
        return MyView('../../../plugins/view/activity/admin/slider/saveinfo');
    }
