...
class Activity extends Common
{
	...
	{
		// 总数
        $total = ActivityService::ActivityTotal($this->form_where);
        ...
        $page_params = [
            ...
            'page'      =>  $this->page,
            'url'       =>  PluginsAdminUrl('activity', 'activity', 'index'),
        ];
        ...
        return MyView('../../../plugins/view/activity/admin/activity/index');
	}
    ...
    public function Detail($params = [])
    {
        ...
        return MyView('../../../plugins/view/activity/admin/activity/detail');
    }
	...
	public function SaveInfo($params = [])
	{
        ...
        return MyView('../../../plugins/view/activity/admin/activity/saveinfo');
	}
