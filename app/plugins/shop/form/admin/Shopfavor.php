    ...
    public function Run($params = [])
    {
        return [
            ...
            'base' => [
                'key_field'     => 'id',
                'is_search'     => 1,
                'search_url'    => PluginsAdminUrl('shop', 'shopfavor', 'index'),
                'is_delete'     => 1,
                'delete_url'    => PluginsAdminUrl('shop', 'shopfavor', 'delete'),
                'delete_key'    => 'ids',
            ],
            // 表单配置
            'form' => [
                ...
                [
                    'label'         => '店铺信息',
                    'view_type'     => 'module',
                    'view_key'      => '../../../plugins/view/shop/admin/shopfavor/module/shop',
                    'grid_size'     => 'lg',
                    'is_sort'       => 1,
                    'sort_field'    => 'shop_id',
                    'search_config' => [
                ...
                [
                    'label'         => '操作',
                    'view_type'     => 'operate',
                    'view_key'      => '../../../plugins/view/shop/admin/shopfavor/module/operate',
                    'align'         => 'center',
                    'fixed'         => 'right',
                ],
            ],
