...
class OrderAftersale
{
    ...
    public function Run($params = [])
    {
        return [
            ...
            'base' => [
                'key_field'     => 'id',
                'is_search'     => 1,
                'search_url'    => PluginsHomeUrl('shop', 'orderaftersale', 'index'),
                'is_middle'     => 0,
            ],
            // 表单配置
            'form' => [
                [
                    'label'         => '基础信息',
                    'view_type'     => 'module',
                    'view_key'      => '../../../plugins/view/shop/index/orderaftersale/module/goods',
                    'grid_size'     => 'lg',
                    'is_sort'       => 1,
                    'sort_field'    => 'goods_id',
                    'search_config' => [
                ...
                [
                    'label'         => '凭证',
                    'view_type'     => 'module',
                    'view_key'      => '../../../plugins/view/shop/index/orderaftersale/module/voucher',
                    'is_list'        => 0,
                ],
                [
                    'label'         => '快递公司',
                ...
                [
                    ...
                    'search_config' => [
                        'form_type'         => 'datetime',
                        'form_name'         => 'oa.upd_time',
                    ],
                ],
                [
                    'label'         => '操作',
                    'view_type'     => 'operate',
                    'view_key'      => '../../../plugins/view/shop/index/orderaftersale/module/operate',
                    'align'         => 'center',
                    'fixed'         => 'right',
                ],
            ],
    ...
    public function WhereBaseGoodsInfo($value, $params = [])
    {
        ...
        {
            // 获取订单详情搜索的订单售后 id
            $ids = Db::name('OrderAftersale')->alias('oa')->join('order_detail od', 'oa.order_detail_id=od.id')->join('order o', 'o.id=oa.order_id and o.shop_user_id='.$this->user_id)->whereOr('od.title|od.model', 'like', '%'.$value.'%')->whereOr('oa.order_no', '=', $value)->column('oa.id');
