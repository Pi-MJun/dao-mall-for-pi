    ...
    public function Run($params = [])
    {
        return [
            ...
            'base' => [
                ...
                'is_search'     => 1,
                'search_url'    => PluginsHomeUrl('shop', 'slider', 'index'),
                'is_delete'     => 1,
                'delete_url'    => PluginsHomeUrl('shop', 'slider', 'delete'),
                'delete_key'    => 'ids',
            ],
            // 表单配置
            'form' => [
                ...
                [
                    'label'         => '图片',
                    'view_type'     => 'module',
                    'view_key'      => '../../../plugins/view/shop/index/slider/module/images',
                    'grid_size'     => 'sm',
                ],
                [
                    'label'         => '事件类型',
                ...
                [
                    ...
                    'view_type'     => 'status',
                    'view_key'      => 'is_enable',
                    'post_url'      => PluginsHomeUrl('shop', 'slider', 'statusupdate'),
                    'is_form_su'    => 1,
                    'align'         => 'center',
                    'search_config' => [
                        'form_type'         => 'select',
                ...
                [
                    'label'         => '操作',
                    'view_type'     => 'operate',
                    'view_key'      => '../../../plugins/view/shop/index/slider/module/operate',
                    'align'         => 'center',
                    'fixed'         => 'right',
                ],
            ],
