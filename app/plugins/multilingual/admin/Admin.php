...
class Admin extends Common
{
    ...
    public function Index($params = [])
    {
        ...
        {
            // 语言列表
            MyViewAssign('lang_list', MultilingualService::MultilingualColumnList());

            MyViewAssign('data', $ret['data']);
            return MyView('../../../plugins/view/multilingual/admin/admin/index');
        } else {
            return $ret['msg'];
        }
    }
    ...
    public function SaveInfo($params = [])
    {
        ...
        if($ret['code'] == 0)
        {
            ...
            MyViewAssign('data', $ret['data']);
            return MyView('../../../plugins/view/multilingual/admin/admin/saveinfo');
        } else {
            return $ret['msg'];
        }
    }
